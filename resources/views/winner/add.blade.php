                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ url('/pemenang/add') }}" class="mt-2" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" id="slug" class="form-control" name="slug" placeholder="slug" required value="{{$slug->slug}}" />

                                        <input type="hidden" id="id_tournament" class="form-control" name="id_tournament" placeholder="id_tournament" required value="{{$slug->id_tournament}}" />
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-status">Team Pemenang</label>
