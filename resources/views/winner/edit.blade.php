...
@section('title') Edit Pemenang @endsection
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Pemenang
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="col-12 mb-2">
                                            <div class="border rounded p-2">
                                                ...
                                                <div class="media flex-column flex-md-row">
                                                    <img src="{{ url('storage/images/pemenang/thumbnail/'.$data->thumbnail) }}" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="130" height="110" alt="thumbnail" />
                                                    <div class="media-body">
